...
int main(int argc, char *argv[])
{
    ...
    */
    ...
    /*********************************************************************************************************/
    puts("|---------------------------------------------------------------------------------------------------------|");
    puts("|extended ASCII table - excluding control characters                                                      |");
    puts("|---Ch-Dec--Hex--|---Ch-Dec--Hex--|---Ch-Dec--Hex--|---Ch-Dec--Hex--|---Ch-Dec--Hex--|---Ch-Dec--Hex--|---Ch-Dec--Hex--|");
    puts("|----------------|----------------|----------------|----------------|----------------|----------------|----------------|");
